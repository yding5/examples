...
#$ -q gpu@qa-1080ti-006         # Specify queue (use ‘debug’ for development)
#$ -l gpu_card=1    # Specify number of GPU cards
#$ -N M01_0       # Specify job name

module load python/3.6.0 torch    # Required modules
#source /opt/crc/c/caffe/1.0.0-rc5/1.0.0
#python mydebug.py
setenv CUDA_VISIBLE_DEVICES 3
python3 neural_style/neural_style.py train --dataset ~/Dataset/COCO/train2014 --style-image images/style-images/mosaic.jpg --save-model-dir models/M01_0/ --epochs 2 --cuda 1 --quantize True --bit 8
